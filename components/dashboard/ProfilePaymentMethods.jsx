...
export default () => {
    ...
    return (
        <>
            <div className="mb-5 grid gap-4 grid-cols-1 lg:grid-cols-3">
                <div>
                    ...
                    <div className="mx-auto w-full max-w-md">
                            ...
                            <div className="space-y-2">
                                {plans.map((plan) => (
                                    <RadioGroup.Option
                                        ...
                                        ${checked ? 'bg-cyan-100 bg-opacity-75 text-black' : 'bg-white'} relative flex cursor-pointer rounded-lg px-5 py-4 shadow-md focus:outline-none`}
                                    >
                                        {({ active, checked }) => (
                                        <>
                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex items-center">
                                                    <div className="flex gap-1.5 items-center">
                                                        <VisaCardIcon className="h-10 w-10" />
                                                        <RadioGroup.Label
                                                            as="p"
                        ...
                        <p className='text-end underline mt-2'>Remove Selected Payment Method</p>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <label
                        htmlFor="term-2"
                        className="cursor-pointer text-xs ps-1 text-gray-500">
...
const VisaCardIcon = (props) => {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="12.909" viewBox="0 0 40 12.909" {...props}>
        <g id="Visa" transform="translate(12139 10935)">
            <path id="Path_5001" data-name="Path 5001" d="M277.461,342.954a22.282,22.282,0,0,1,.9-2.288l.428,2.336c.084.388.166.771.25,1.156.078.354.191.783.239,1.134l-2.669-.006.848-2.332Zm-2.533,6.8c.229-.128.587-1.843.789-1.89l4.009,0c.129.026.109.114.138.27.1.534.257,1.1.339,1.617l2.994-.007-2.611-12.489c-.877-.018-1.838-.032-2.71.011a1.531,1.531,0,0,0-1.54,1.133c-.511,1.258-1.044,2.525-1.575,3.773s-1.053,2.526-1.586,3.794l-1.57,3.785Z" transform="translate(-12382.195 -11272.015)" fill="#0066b2" fill-rule="evenodd"/>
            <path id="Path_5002" data-name="Path 5002" d="M270.456,340.2l.394-2.724a6.5,6.5,0,0,0-1.512-.385c-2.6-.429-6.118.362-6.748,3.331a3.124,3.124,0,0,0,1.289,3.189c1.2.953,3.17,1.422,3.172,2.432a1.246,1.246,0,0,1-.858,1.045,4.563,4.563,0,0,1-1.639.166,7.66,7.66,0,0,1-2.9-.82l-.465,2.807c.218.049.478.172.721.244,2.49.736,6.18.636,7.827-1.658a3.818,3.818,0,0,0,.6-2.929,2.812,2.812,0,0,0-.63-1.254c-.177-.175-.263-.3-.457-.468-.98-.831-2.081-1.077-2.868-1.758-.322-.277-.744-.578-.3-1.225.505-.736,2.164-.647,2.981-.46a12.748,12.748,0,0,1,1.394.468Z" transform="translate(-12380.776 -11271.979)" fill="#0066b2" fill-rule="evenodd"/>
            <path id="Path_5003" data-name="Path 5003" d="M247.231,344.1a8.25,8.25,0,0,0-1.794-3.065,4.139,4.139,0,0,0-.288-.33.991.991,0,0,1-.158-.149,11.209,11.209,0,0,0-2.2-1.682c.067.426.574,2.154.725,2.743l1.431,5.423c.229.9.5,1.8.727,2.69l3.367.022c.045-.2.534-1.282.655-1.578.213-.524.427-1.03.643-1.55.873-2.086,1.69-4.191,2.553-6.289.283-.69,1.074-2.531,1.265-3.094l-3.427,0-3.14,8.492c-.144-.278-.193-1.384-.362-1.632Z" transform="translate(-12378.269 -11272.016)" fill="#0066b2" fill-rule="evenodd"/>
            <path id="Path_5004" data-name="Path 5004" d="M260.367,337.239l-3.223.01c-.358,2.069-.67,4.154-1.005,6.222l-.752,4.7c-.075.5-.19,1.069-.224,1.568h3.2l2-12.5Z" transform="translate(-12379.954 -11272.015)" fill="#0066b2" fill-rule="evenodd"/>
            <path id="Path_5005" data-name="Path 5005" d="M242.237,338.874a11.208,11.208,0,0,1,2.2,1.682.993.993,0,0,0,.158.149,4.125,4.125,0,0,1,.288.33,8.251,8.251,0,0,1,1.794,3.065c.043-.164-.5-2.7-.582-3.114a22.373,22.373,0,0,0-.682-3.084,1.274,1.274,0,0,0-1.239-.649c-1.213-.038-2.512,0-3.748-.018a3.8,3.8,0,0,0-1.712.168c.006.005.017,0,.02.014s.016.011.021.014c.16.082-.056-.021.045.022l.361.119a14.307,14.307,0,0,1,3.078,1.3Z" transform="translate(-12377.712 -11272.012)" fill="#faa819" fill-rule="evenodd"/>
        </g>
    </svg>
    )
}
...
const MasterCardIcon = (props) => {
    return(        
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="31.122" viewBox="0 0 40 31.122">
